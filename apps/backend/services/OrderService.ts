...
export class OrderService {
  ...
  async createOrder(input: {
    ...
    if (!product && !["mobile-legends", "mobile-legends-philippines", "mobile-legends-indonesia", "mlbb", "free-fire", "free-fire-khsgmy", "pubg-mobile", "honor-of-kings", "hok", "valorant", "zepeto", "delta-force", "blood-strike", "magic-chess-gogo", "crossfire-legend"].includes(input.gameSlug)) {
    ...
    const isCatalogGame = ["mobile-legends", "mobile-legends-philippines", "mobile-legends-indonesia", "mlbb", "free-fire", "free-fire-khsgmy", "pubg-mobile", "honor-of-kings", "hok", "valorant", "zepeto", "delta-force", "blood-strike", "magic-chess-gogo", "crossfire-legend"].includes(input.gameSlug);
