...
export async function GET(
  ...
  const game = await safeDbQuery(
    ...
    null,
    ["mobile-legends", "mobile-legends-philippines", "free-fire", "pubg-mobile", "honor-of-kings", "valorant", "zepeto", "delta-force", "blood-strike", "magic-chess-gogo", "crossfire-legend"].includes(normalizedSlug) ? 5000 : 800
  );
  ...
  if (["mobile-legends", "mobile-legends-philippines", "free-fire", "pubg-mobile", "honor-of-kings", "valorant", "zepeto", "delta-force", "blood-strike", "magic-chess-gogo", "crossfire-legend"].includes(normalizedSlug)) {
    return NextResponse.json(
