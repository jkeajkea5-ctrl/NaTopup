  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <section id="games" aria-labelledby="popular-games-title" className="popular-games scroll-mt-24 space-y-5">
        ...
        {/* Product Grid: 3 cards on mobile, 6 cards on laptop/tablet/desktop (Zero gaps) */}
        {isLoading ? (
          <div className="grid grid-cols-3 md:grid-cols-6 lg:grid-cols-6 gap-2.5 sm:gap-3 md:gap-3.5 lg:gap-4">
            {[1, 2, 3, 4, 5, 6].map((n) => (
              <div
                key={n}
