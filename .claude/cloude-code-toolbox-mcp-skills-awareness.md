...
_Generated: 2026-09-21T13:01:59.639Z_
...
Workspace `mcp.json` _(folder: Lukas)_

- **d:\Builder WebSite\Lukas\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\ASUS\.claude.json** — _File exists — no servers defined_
